...
As [NCBI](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1065119/) puts it, logistic regression "is a method for modelling the dependence of a binary response variable on one or more explanatory variables." In our case we have the binary response variable of points gotten in the final exam; if one has a score higher than the median of points (23) they will have 1, as ones with a lower score get a zero. The regression model then attempts to estimate the dependent variable in the best fashion. 

The model offers the quantitities of the effects as log odds. Log odds
